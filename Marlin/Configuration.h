...
//#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -0.95  // Z probe to nozzle Z offset: -below (always!) was -0.95
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,96.5}  // default steps per unit for Ultimaker
