...
#define STRING_CONFIG_H_AUTHOR "(silasb, default config)" // Who made the changes.
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { -15, 0, (Z_MIN_POS + 10)}
  #define NOZZLE_CLEAN_END_POINT   {10, 20, (Z_MIN_POS + 10)}
